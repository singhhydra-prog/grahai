...
const ml: Translations = {
  ...
  onboarding: {
    ...
    intentTitle: "നിങ്ങളുടെ ഹൃദയം കേന്ദ്രീകരണം ഏതിനെക്കുറിച്ച് ആഗ്രഹിക്കുന്നു?",
    ...
    trustCard1Title: "നിങ്ങളുടെ ജാതകത്തിൽ നിന്നും ജനിച്ചത്",
    trustCard1Desc: "ഓരോ ഉൾക്കാഴ്ചയും നിങ്ങളുടെ അനന്യ കോസ്മിക് ബ്ലൂപ്രിന്റിൽ നിന്ന് വരുന്നു — സാധാരണമായ ഒന്നും ഇല്ല, ക്രമരഹിതമായ ഒന്നും ഇല്ല.",
    trustCard2Title: "പുരാതന ജ്യോതിഷത്തിൽ ഭിത്തി",
    trustCard2Desc: "വേദിക പരമ്പരയിലൂടെ കാലങ്കഴിഞ്ഞ മാർഗ്ഗനിർദ്ദേശം ഓരോ വായനയുടെയും ശരീരം നിർദ്ദേശിക്കുന്നു.",
    trustCard3Title: "പ്രധാനമായ തീരുമാനങ്ങൾക്കായി നിർമ്മിച്ചത്",
    trustCard3Desc: "കരിയറ്, പ്രേമം, സമയം, പണം — ഗ്രഹങ്ങളെ നിങ്ങളുടെ പാത്ത് വെളിച്ചം കൊണ്ട് ഞരിപ്പിക്കാൻ അനുവദിക്കുക.",
...
const bn: Translations = {
  ...
  onboarding: {
    ...
    intentTitle: "আপনার হৃদয় কোন বিষয়ে স্পষ্টতা চায়?",
    ...
    trustCard1Title: "আপনার কুণ্ডলী থেকে জন্ম",
    trustCard1Desc: "প্রতিটি অন্তর্দৃষ্টি আপনার অনন্য মহাজাগতিক নীলনকশা থেকে আসে — কিছু জেনেরিক নয়, কিছু এলোমেলো নয়।",
    trustCard2Title: "ধ্রুপদী জ্যোতিষে ভিত্তি করে",
    trustCard2Desc: "বৈদিক ঐতিহ্যের শতাব্দীর মাধ্যমে হাতে-কলমে জ্ঞান প্রতিটি পড়াকে গাইড করে।",
    trustCard3Title: "যে সিদ্ধান্তগুলি গুরুত্বপূর্ণ তার জন্য তৈরি",
    trustCard3Desc: "ক্যারিয়ার, ভালোবাসা, সময়, অর্থ — গ্রহগুলিকে আপনার পথ আলোকিত করতে দিন।",
...
const mr: Translations = {
  ...
  onboarding: {
    ...
    intentTitle: "तुमचे हृदय कशाबद्दल स्पष्टता शोधत आहे?",
    ...
    trustCard1Title: "तुमच्या कुंडलीमधून जन्मलेले",
    trustCard1Desc: "प्रत्येक अंतर्दृष्टि तुमच्या अनन्य ब्रह्मांडीय नकाशातून येते — काही सामान्य नाही, काही यादृच्छिक नाही।",
    trustCard2Title: "शास्त्रीय ज्योतिषमध्ये आधारित",
    trustCard2Desc: "वैदिक परंपरेच्या शतकांमधून ज्ञान प्रत्येक वाचनचा मार्गदर्शन करतो।",
    trustCard3Title: "महत्वाच्या निर्णयांसाठी तयार केलेले",
    trustCard3Desc: "करिअर, प्रेम, वेळ, पैसा — ग्रहांना तुमचा मार्ग प्रकाशित करू द्या।",
...
const gu: Translations = {
  ...
  onboarding: {
    ...
    intentTitle: "તમારું હૃદય શું સ્પષ્ટતા શોધી રહ્યું છે?",
    ...
    trustCard1Title: "તમારી કુંડળીમાંથી જન્મ",
    trustCard1Desc: "દરેક અંતર્દୃષ્ટિ તમારા અનન્ય મહાકાશીય લેઆઉટમાંથી આવે છે — કાંઈ સામાન્ય નથી, કાંઈ અનિયમિત નથી।",
    trustCard2Title: "શાસ્ત્રીય જ્યોતિષમાં આધારિત",
    trustCard2Desc: "વૈદિક પરંપરાના સદીઓમાંથી જ્ઞાન દરેક વાચનને માર્ગદર્શન આપે છે।",
    trustCard3Title: "મહત્વના નિર્ણયો માટે બનાવેલ",
    trustCard3Desc: "કેરિયર, પ્રેમ, સમય, પૈસા — ગ્રહોને તમારો પાથ પ્રકાશિત કરવા દો.",
