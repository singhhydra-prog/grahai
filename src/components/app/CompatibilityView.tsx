...
import {
  ...
  ChevronUp, MessageCircle, Share2, RefreshCw, Check, X, ArrowLeft
} from "lucide-react"
...
export default function CompatibilityView({ onBack, onAskAI }: { onBack: () => void; onAskAI: () => void }) {
    ...
    return (
      <div className="relative min-h-screen bg-[#0a0a0f]">
        ...
        <div className="sticky top-0 z-50 flex items-center gap-3 px-4 py-3 bg-[#0a0a0f]/90 backdrop-blur-xl border-b border-white/[0.04]">
          ...
          <h1 className="text-lg font-bold text-white">Compatibility Check</h1>
        </div>
