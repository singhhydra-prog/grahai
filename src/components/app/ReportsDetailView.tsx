...
/* ════════════════════════════════════════════════════════
   Reports Detail View Component

   Reusable overlay component for listing generated PDF
   Kundli reports, generating new ones, and viewing/downloading
   existing reports.
   ════════════════════════════════════════════════════════ */
...
export default function ReportsDetailView({ onBack, onUpgrade, onAskAI }: ReportsDetailViewProps) {
    ...
    <div className="min-h-screen bg-bg pb-20 flex flex-col">
      ...
      <header className="sticky top-0 z-40 bg-[#0a0e1a]/95 backdrop-blur-xl border-b border-white/[0.06]">
        <div className="flex items-center gap-3 px-4 h-14">
          ...
          <h1 className="text-sm font-bold text-white">Kundli Reports</h1>
        </div>
      </header>

      <div className="max-w-3xl mx-auto px-6 pt-6 space-y-8 flex-1">
        {/* Header */}
        <motion.div
