      ...
      <section className="relative pt-40 pb-24 px-6 lg:px-10">
        <div className="mx-auto max-w-3xl">
          ...
          <BlurReveal delay={0.1}>
            <h1 className="heading-section mb-8">Terms of <span className="gold-text">Service</span></h1>
          </BlurReveal>
          <BlurReveal delay={0.2}>
            <div className="prose-custom space-y-8 text-text/60 text-[15px] leading-relaxed">
              ...
              <div>
                <h2 className="text-lg font-semibold text-text/80 mb-3">1. Acceptance of Terms</h2>
              ...
              <div>
                <h2 className="text-lg font-semibold text-text/80 mb-3">2. Service Description</h2>
              ...
              <div>
                <h2 className="text-lg font-semibold text-text/80 mb-3">3. Disclaimer</h2>
              ...
              <div>
                <h2 className="text-lg font-semibold text-text/80 mb-3">4. User Accounts</h2>
              ...
              <div>
                <h2 className="text-lg font-semibold text-text/80 mb-3">5. Subscriptions &amp; Payments</h2>
              ...
              <div>
                <h2 className="text-lg font-semibold text-text/80 mb-3">6. Intellectual Property</h2>
              ...
              <div>
                <h2 className="text-lg font-semibold text-text/80 mb-3">7. Limitation of Liability</h2>
              ...
              <div>
                <h2 className="text-lg font-semibold text-text/80 mb-3">8. Contact</h2>
                <p>Questions about these terms? Email us at <a href="mailto:hello@grahai.in" className="text-gold/60 hover:text-gold transition-colors">hello@grahai.in</a>.</p>
              </div>
            </div>
          </BlurReveal>
        </div>
